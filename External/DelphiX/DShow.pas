...
type
  ...
  IMediaSample = interface(IUnknown)
    ...
    function GetMediaTime(var pTimeStart, pTimeEnd: Int64): HResult; stdcall;
    function SetMediaTime(const pTimeStart, pTimeEnd: Int64): HResult; stdcall;
  end;
...
type
  IMediaSeeking = interface(IUnknown)
    ...
    function GetDuration(var pDuration: Int64): HResult; stdcall;
    function GetStopPosition(var pStop: Int64): HResult; stdcall;
    function GetCurrentPosition(var pCurrent: Int64): HResult; stdcall;
    function ConvertTimeFormat(var pTarget: Int64; const pTargetFormat: TGUID;
        Source: Int64; const pSourceFormat: TGUID): HResult; stdcall;
    function SetPositions(var pCurrent: Int64; dwCurrentFlags: DWORD;
        var pStop: Int64; dwStopFlags: DWORD): HResult; stdcall;
    function GetPositions(var pCurrent, pStop: Int64): HResult; stdcall;
    function GetAvailable(var pEarliest, pLatest: Int64): HResult; stdcall;
    function SetRate(dRate: double): HResult; stdcall;
    function GetRate(var pdRate: double): HResult; stdcall;
    function GetPreroll(var pllPreroll: Int64): HResult; stdcall;
  end;
...
type
  ...
  IAsyncReader = interface(IUnknown)
    ...
    function SyncRead(llPosition: Int64; lLength: Longint; var pBuffer): HResult; stdcall;
    function Length(var pTotal, pAvailable: Int64): HResult; stdcall;
    function BeginFlush: HResult; stdcall;
    function EndFlush: HResult; stdcall;
  end;
...
type
  IAMVideoCompression = interface(IUnknown)
    ...
    function get_WindowSize(var pWindowSize: Int64): HResult; stdcall;
